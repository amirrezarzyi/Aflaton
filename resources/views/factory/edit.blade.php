            ...
            <form action="{{ route('admin.factories.update',$factory->id) }}" method="post">
               ...
               <div class="box-body">
                  <div class="row mbn-20">
                     <div class="col-6 mb-15"><input name="title" type="text" class="form-control" value="{{$factory->title}}"></div>
                     <div class="col-6 mb-15"><input name="full_name" type="text" class="form-control" value="{{$factory->full_name}}"></div>
